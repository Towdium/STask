...
public class TS1L1 extends Tutorial.Impl {
    static final String S1S1 = "Welcome! This game aims to teach the " +
    ...
    static final String S1S2 = "This is an example task. The first row shows " +
            "cost and type (we will talk about it later), and the second row " +
            "shows the name of the task.";
    static final String S1S3 = "This is a task graph. When you hover " +
            "over any task, all related communications will be highlighted " +
            "with size of data.";
    static final String S1S4 = "Inside one task graph, if there is any connection between " +
    ...
    static final String S1S5 = "In the top left corner, it shows the game timer, counting the " +
    ...
    static final String S1S6 = "On the left hand side it shows several processors. " +
            ...
            "and communication.";
    static final String S1S7 = "Let's get started by assigning task a to processor a.";
    static final String S2S1 = "The appearance of tasks change according to the state. " +
    ...
    static final String S3S2 = "You can reset the game using the control panel in the lower right corner. " +
    ...
    private void allocate() {
        ...
        widget.update(S1S1, true);

        Game g = new Game("1-1t");
        Graph r = g.getGraphs().iterator().next();
        widget.update((p, m) -> {
            p.drawTextWrapped(S1S2, 10, 140 + Painter.fontAscent, WTutorial.WIDTH - 20);
        ...
        widget.update((p, m) -> {
            ...
            p.drawTextWrapped(S1S3, 10, 200 + Painter.fontAscent, WTutorial.WIDTH - 20);
        }, false);

        widget.update(S1S4, false);
        widget.update(S1S5, false);
        widget.update(S1S6, false);
        widget.update(S1S7, false);
    }
    ...
    private void start() {
        ...
        widget.update(S2S1, true);
        widget.update(S2S2, false, "S2S2");
    }
